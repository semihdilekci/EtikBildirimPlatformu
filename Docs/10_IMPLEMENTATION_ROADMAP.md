...
- Prisma schema v1:
  ...
  - `audit_logs` (append-only placeholder — chain hash Faz 3)
...
- Auth modülü:
  ...
  - `AuthController` — `/auth/login`, `/auth/callback`, `/auth/logout`, `/auth/me`
...
- apps/api/src/modules/case-management/transition/__tests__/transition.service.spec.ts

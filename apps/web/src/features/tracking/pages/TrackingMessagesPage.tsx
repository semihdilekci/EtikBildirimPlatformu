    ...
    >
      <Paper
        ...
        sx={{
          ...
          px: 2,
          py: 1.5,
          bgcolor: isOutbound ? brandColors.red.wash : 'grey.50',
          borderColor: isOutbound ? 'primary.main' : 'grey.200',
        }}
      >
...
export function TrackingMessagesPage() {
  ...
  return (
    <FormPanel maxWidth={640}>
      <Stack spacing={2} sx={{ mb: 2, minHeight: '60vh' }}>
        <PageHeader
          align="center"
          title="Mesajlar"
          subtitle="Kurul sekretaryası ile güvenli yazışma"
        />

        <TrackingSubNav activeTab="messages" />
